...
class TestResetPass:
    ...
    def test_open_reset_pass_page_pass(self, driver):
        ...
        element.open_reset_pass_page()
        assert element.get_current_url() == api_urls.FORGOT_PASS_PAGE_URL
    ...
    def test_vosstanovit_pass_enter_email_pass(self, driver):
        element = ResetPass(driver)
        element.vosstanovit_pass_enter_email()
        assert element.get_current_url() == api_urls.RESET_PASS_PAGE_URL
